...
_MCP_INSTRUCTIONS = (
    ...
    "  - All Google Gemini products (Gemini CLI, gemini-cli, aistudio, etc.) → base: \"gemini\"\n"
    "  - Google Antigravity CLI (agy, antigravity) → base: \"agy\" (NOT \"gemini\")\n"
    ...
    "CRITICAL — Identity:\n"
    "Always use your base agent name (claude/codex/gemini/agy/qwen/kilo) as sender. "
